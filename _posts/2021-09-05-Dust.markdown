...
<div  style="width:100%;">
    ...
    <div style="float:center; width:30%;">
        ...
        <br/>
        <p style='font-size:9px'>Carina Nebula (through HST/WFC3) in UV/optical (top) and IR (bottom) wavebands.  The composite image was made from filters that isolate emission from iron, magnesium, oxygen, hydrogen,and sulfur. [© NASA, ESA, and the Hubble SM4 ERO Team</p>
        <br/>
    </div>
</div>
